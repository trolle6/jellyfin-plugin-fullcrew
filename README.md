...
[![Version](https://img.shields.io/badge/version-1.8.7.0-00a4dc)](meta.json)
...
2. Copy `Jellyfin.Plugin.FullCrew.dll` and `meta.json` into a **single** plugin folder, e.g. `plugins/Jellyfin.Plugin.FullCrew_1.8.7.0/`. Remove any older `Jellyfin.Plugin.FullCrew_*` / `Full Crew_*` folders first — Jellyfin 10.11 will try to load every copy.
